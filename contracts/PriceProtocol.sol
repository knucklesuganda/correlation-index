...
contract PriceOracle {
    ...
    IUniswapV3Factory private factory;  // 0x1F98431c8aD98523631AE4a59f267346ea31F984

    constructor(address uniswapFactoryAddress) {
        factory = IUniswapV3Factory(uniswapFactoryAddress);
    }
